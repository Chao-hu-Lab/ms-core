...
def test_algorithm_marker_selects_processing_regressions() -> None:
    ...
    data_organizer_layout = classify_test_markers(
        Path("tests") / "test_data_organizer_layout.py"
    )
    data_organizer_method = classify_test_markers(
        Path("tests") / "test_data_organizer_method.py"
    )
